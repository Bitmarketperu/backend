...
const addTransaction = ( wallet, id, reciveUser, payMethod, reciveMethod, bank, bankAdmin, amountSend, amountReceive, moneySend, moneyReceive, network, status ) => {
    return new Promise( async (resolve, reject) => {
        try {
            ...
            const transaction = await store.add( {wallet, id, reciveUser, payMethod, reciveMethod, bank, bankAdmin, amountSend, amountReceive, moneySend, moneyReceive, network, status, date} );
